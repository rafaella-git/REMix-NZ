...
def add_hydro(m):
    ...
    hydro_techs = ["Turbine"]
    hydro_nodes = [n for n in m.set.nodesdata if not n.startswith("LNG")]
    ...
    #model regions years techs
    hydro_cap.loc[idx[:, :, hydro_techs], "unitsUpperLimit"] = 100  # GW_el
    hydro_cap.loc[idx[["WTO"], [2020], "Turbine"], "unitsBuild"] = 2  # GW_el
